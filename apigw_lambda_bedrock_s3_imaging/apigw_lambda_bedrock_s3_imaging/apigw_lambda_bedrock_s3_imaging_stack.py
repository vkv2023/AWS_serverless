...
class ApigwLambdaBedrockS3ImagingStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        PIL_layer = _lambda.LayerVersion.from_layer_version_arn(self, "PIL_Layer",
                                                                'arn:aws:lambda:us-east-1:770693421928:layer:Klayers-p311-Pillow:2')
        boto_layer = _lambda.LayerVersion.from_layer_version_arn(self, "Boto3Layer",
                                                                 'arn:aws:lambda:us-east-1:770693421928:layer:Klayers-p311-boto3:5')
